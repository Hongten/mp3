 ...
 */
public class SoundPlayerTest extends JComponent {
	//http://i2534.iteye.com/blog/775167
	...
	public static void main(String[] args) throws IOException,
		...
		SoundPlayerTest player;

		//File file = new File("C:/Program Files/115/115com/down.wav"); // This is the file we'll be playing
		File file = new File("C:/Program Files/TortoiseSVN/bin/TortoiseSVN_Notification.wav");
		...
		player = new SoundPlayerTest(file, ismidi);
	...
	public SoundPlayerTest(File f, boolean isMidi) throws IOException,
			UnsupportedAudioFileException, LineUnavailableException,
			MidiUnavailableException, InvalidMidiDataException {
	...
	// DataLine.Info(SourceDataLine.class,ain.getFormat());
	// /*
	...
	// sline.open();
	// FloatControl
	// volctrl=(FloatControl)sline.getControl(FloatControl.Type.MASTER_GAIN);
